# This Makefile is for the Test::MockTime extension to perl.
#
...
#	NAME => q[Test::MockTime]
#	PREREQ_PM => { Time::Local=>q[0], Test::More=>q[0] }
#	VERSION_FROM => q[lib/Test/MockTime.pm]
...
AR_STATIC_ARGS = cr
NAME = Test::MockTime
DISTNAME = Test-MockTime
NAME_SYM = Test_MockTime
VERSION = 0.01
VERSION_SYM = 0_01
XS_VERSION = 0.01
INST_BIN = blib/bin
...
HTMLSCRIPTPODS = 
MAN1PODS = 
MAN3PODS = lib/Test/MockTime.pod
HTMLEXT = html
...
TO_INST_PM = lib/Test/MockTime.pm \
	lib/Test/MockTime.pod \
	mass.pl

PM_TO_BLIB = lib/Test/MockTime.pm \
	$(INST_LIB)/Test/MockTime.pm \
	lib/Test/MockTime.pod \
	$(INST_LIB)/Test/MockTime.pod \
	mass.pl \
	$(INST_LIBDIR)/mass.pl
...
manifypods : pure_all lib/Test/MockTime.pod
	@$(POD2MAN) \
	lib/Test/MockTime.pod \
	$(INST_MAN3DIR)/Test::MockTime.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -f  $(INST_LIB)/Test/MockTime.pm $(INST_LIB)/Test/MockTime.pod
	rm -f $(INST_LIBDIR)/mass.pl
